...
# with command line options: Configuration/SMP-22-010_NanoGen/python/ZJToMuMu_CT18variations_singleJob.py --fileout file:ZJToMuMu_CT18variations_singleJob.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/ZJToMuMu_CT18variations_singleJob.py --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=999\nprocess.genWeightsTable.maxPdfWeights=1000 -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/SMP-22-010_NanoGen/python/ZJToMuMu_CT18variations_singleJob.py nevts:10'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:ZJToMuMu_CT18variations_singleJob.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/afs/cern.ch/user/f/fvazzole/public/mygrid.tgz'),
