...
# with command line options: Configuration/SMP-22-010_NanoGen/python/SMP-RunIISummer20UL16wmLHEGEN-00645_onlys2wAndScaleWeights_cff.py --fileout file:SMP-RunIISummer20UL16wmLHEGEN-00645_onlys2wAndScaleWeights_cff.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/SMP-RunIISummer20UL16wmLHEGEN-00645_onlys2wAndScaleWeights_cfg.py --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=999 -n 1000 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/SMP-22-010_NanoGen/python/SMP-RunIISummer20UL16wmLHEGEN-00645_onlys2wAndScaleWeights_cff.py nevts:1000'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:SMP-RunIISummer20UL16wmLHEGEN-00645_onlys2wAndScaleWeights_cff.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/afs/cern.ch/user/f/fvazzole/work/smp-22-010_genproduction/MiNNLOSamples/tarballs/RunIISummer20UL16wmLHEGEN-00645/Zj_slc7_amd64_g10_CMSSW_12_3_1_ZJToMuMu-suggested-nnpdf31-ncalls-doublefsr-q139-powheg-MiNNLO31-svn3900-ew-rwl6-j200-st2fix-ana-hoppetweights-ymax20-pdf3_onlys2wAndScaleWeights.tgz'),
