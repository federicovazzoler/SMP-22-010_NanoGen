...
# with command line options: Configuration/SMP-22-010_NanoGen/python/ZJToMuMu_CT18variations_singleJob_final.py --fileout file:ZJToMuMu_CT18variations_singleJob_final.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/ZJToMuMu_CT18variations_singleJob_final.py --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=999\nprocess.genWeightsTable.maxPdfWeights=1000 -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/SMP-22-010_NanoGen/python/ZJToMuMu_CT18variations_singleJob_final.py nevts:10'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:ZJToMuMu_CT18variations_singleJob_final.root'),
